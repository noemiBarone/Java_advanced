...
public class Main {
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [Non sono nell'ordine in cui li ho inseriti]
        ...
        //2b. What will this output? [Non sono nell'ordine in cui li ho inseriti o uniti]
        System.out.println(fruitsSet);
    }
    ...
    private static void exercise3() {
       ...
       for (Integer firstNumber : setA ){
           for(Integer secondNumber : setB){
               if(firstNumber == secondNumber){
                   itemsContainedInBothSets.add(firstNumber);
               }
           }
       }
