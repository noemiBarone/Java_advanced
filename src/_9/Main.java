...
import _9.esercizio1.Cerchio;
import _9.esercizio1.Rettangolo;
import _9.esercizio2.Boat;
import _9.esercizio2.Car;
import _9.esercizio3.Guitar;
import _9.esercizio3.Piano;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        Cerchio cerchio = new Cerchio(6,6);
        double areaCerchio = cerchio.calculateArea();
        double areaRettangolo = rettangolo.calculateArea();
    ...
    private static void exercise3() {
        System.out.println("\nExercise 3: ");
        Guitar guitar = new Guitar("Elettrica", "Fender");
        Piano piano = new Piano("A coda", "Yamaha");
        guitar.play();
        piano.play();
    }
}
